...
export default function Item({id, name, price, img}){
    ...
    return(
        <div className="flex flex-col items-center my-[20px] m-1 p-2">
            <Link to={`/products/${id}`} className="rounded hover:scale-105 transition-all duration-500 cursor-pointer h-80"><img className="rounded" src={img} alt="Imagen Productos" /></Link>
